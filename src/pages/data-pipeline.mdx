---
layout: "@/layouts/DataPipeline"
title: "The Data Pipeline"
description: "A 7-step methodology to structure your data projects."
---
import { Image } from "astro:assets";
import StepBar from "@/components/pipeline/StepBar";
import Step from "@/components/pipeline/Step";
import Row from "@/components/pipeline/Row";
import pipelineSvg from "@/assets/data_pipeline_views_pipeline.svg";
import tasksSvg from "@/assets/data_pipeline_views_tasks.svg";

<Row prompt="intro">
**A 7-step methodology to structure your data projects.**

<p class="pipeline-subtitle">Created by <a class="cactus-link" href="https://web.archive.org/web/20220417194310/https://schoolofdata.org/">School of Data</a>, refined by CLI.</p>
...
<Step num={1} id="define" title="Define">
...
<details class="pipeline-details" style="margin-top: 1em;">
...
<Step num={4} id="verify" title="Verify">
...
<Step num={5} id="clean" title="Clean">
...
<Step num={6} id="analyze" title="Analyze">
...
<Step num={7} id="present" title="Present">
...
<Row prompt="exec" style="margin-top: 2em;">
...
<Image src={pipelineSvg} alt="Steps contain tasks" style="width: 100%; height: auto; border-radius: 6px; margin: 1.5em 0;" />
...
<Image src={tasksSvg} alt="Tasks fork, converge, and loop back" style="width: 100%; height: auto; border-radius: 6px; margin: 1.5em 0;" />
